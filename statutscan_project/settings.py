"""
Django settings for statutscan_project project.
...
SECRET_KEY = 'django-insecure-kbcr8n3wr9gxsvo7@9i4m@uk^6ml(=pkflc-u_pos*9*04)u9)'
...
# Database settings are temporary.
